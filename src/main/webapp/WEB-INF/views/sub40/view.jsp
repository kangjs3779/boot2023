...
<body>
	...
	<div>
		<button id="btn10">본문있는 성공 응답10</button>
		<div id="res10"></div>
	</div>
	<div>
		<button id="btn11">본문있는 성공 응답11</button>
		<div id="res11"></div>
	</div>
	<div>
		<button id="btn12">본문있는 성공 응답12</button>
		<div id="res12"></div>
	</div>
	<div>
		<button id="btn13">본문있는 성공 응답13</button>
		<div id="res13"></div>
	</div>
	<div>
		<input type="text" id="categoryIdInput" />
		<button id="btn14">객체응답</button>
		<div>
			<div id="res14"></div>
		</div>
	</div>
	<div>
		<input type="text" id="categoryIdInput2" />
	...
	<script src="/js/sub40/ajax.js"></script>
</body>
</html>
